...
<body>
    ...
    <form class="form" action="<?php echo base_url('index.php/Taskcontroller/addtask'); ?>" method="post">
    <div class="h2 mb-4">Add task</div>
    <div class="form-floating mb-3 mt-3">
    <textarea name="task" class="form-control" id="task" rows="4"></textarea>
    <label for="task">Task</label>
    </div>
    <button for="submit" class="btn btn-outline-primary  mt-3 mb-3">Add task</button>
    </form>
    </div>
    </div>
</body>
